...
export const TrackingTimeline: React.FC<TrackingTimelineProps> = ({ 
  ...
  const steps: StepItem[] = [
    ...
    },
    {
      key: 'RECEIVED',
      stepNumber: 2,
      statusMatch: ['RECEIVED_AT_ORIGIN', 'RECEIVED_AT_ORIGIN_HUB', 'INSPECTED_SEALED', 'INSPECTED_AND_SEALED', 'WEIGHT_ADJUSTMENT_PENDING', 'WEIGHT_DISCREPANCY_PENDING'],
    ...
    },
    {
      key: 'AIR_FREIGHT',
      stepNumber: 3,
      statusMatch: ['ASSIGNED_TO_TRIP', 'ASSIGNED_TO_TRAVELER', 'IN_TRANSIT', 'IN_TRANSIT_AIR', 'IN_FLIGHT'],
      titleAr: 'جاري الشحن الجوي',
      titleEn: 'Air Freight in Progress',
      descAr: `الطرد الآن في رحلة الشحن الجوي باتجاه (${destHub?.cityAr || 'بلد الوجهة'}) مع مسار النقل المعتمد.`,
      descEn: `Parcel is in air transit towards (${destHub?.cityEn || 'Destination Hub'}) with authorized dispatch.`,
      icon: Plane,
    },
    {
      key: 'CUSTOMS',
      stepNumber: 4,
      statusMatch: ['CUSTOMS_CLEARANCE', 'CUSTOMS_HELD', 'RECEIVED_AT_DEST', 'RECEIVED_AT_DEST_HUB'],
    ...
    },
    {
      key: 'DELIVERED',
      stepNumber: 6,
      statusMatch: ['DELIVERED', 'COMPLETED'],
      titleAr: 'تم التسليم',
