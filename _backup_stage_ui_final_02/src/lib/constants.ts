import { CustomsDutyRule, DailyExchangeRate, Employee, Hub, PublicAnnouncement, RoutePricing, ShippingRate, ThemeMode, User } from '../types';
...
export const INITIAL_PUBLIC_ANNOUNCEMENTS: PublicAnnouncement[] = [
  {
    id: 'ANN-001',
    titleAr: 'المسار المباشر المعتمد: عمان (AMM) ⇄ الجزائر (ALG) لشحن الأمتعة والطرود',
    titleEn: 'Active Direct Route: Amman (AMM) ⇄ Algiers (ALG) for Express Parcel Shipping',
    bodyAr: 'استقبلت مراكزنا في عمان والجزائر رحلات شحن مؤكدة بضمان مالي بنسبة 100% وأختام رقمية مشفرة وفحص أمني معتمد.',
    bodyEn: 'Certified direct transit now active between Amman and Algiers hubs with 100% escrow protection and cryptographic tamper-evident seals.',
    placement: 'TOP_BANNER',
    priority: 100,
    startAt: '2025-01-01T00:00:00.000Z',
    endAt: '2028-12-31T23:59:59.000Z',
    status: 'ACTIVE',
    isDismissible: true,
    badgeAr: 'مسار نشط',
    badgeEn: 'Active Route',
    ctaLabelAr: 'احجز شحنتك الآن',
    ctaLabelEn: 'Ship Parcel Now',
    ctaTarget: 'SENDER',
  ...
  {
    id: 'ANN-002',
    titleAr: 'حماية وضمان مالي 100% لكافة الشحنات والأمانات المصرحة',
    titleEn: '100% Financial Escrow Protection on All Declared Shipments',
    bodyAr: 'يحجز المسافر تأميناً نقدياً مسترداً يطابق قيمة الأغراض المصرحة لضمان أمان كامل من الاستلام حتى التسليم النهائي.',
    bodyEn: 'Travelers lock a refundable cash deposit matching declared parcel value, guaranteeing complete peace of mind through delivery.',
    ...
    isDismissible: false,
    badgeAr: 'حماية وضمان',
    badgeEn: 'Trust & Safety',
    ctaLabelAr: 'حساب التسعير الفوري',
    ctaLabelEn: 'Instant Calculator',
  ...
  {
    id: 'ANN-003',
    titleAr: 'إيداع الطرود في مراكز الفحص قبل 24 ساعة من موعد إقلاع الرحلة',
    titleEn: 'Parcel Intake & Inspection Closes 24 Hours Before Flight Departure',
    bodyAr: 'يرجى تسليم الطرود إلى المركز المعتمد مبكراً لإنهاء إجراءات الفحص الأمني، الوزن، والتغليف بالأختام الرقمية المشفرة.',
    bodyEn: 'Drop off parcels in advance at local certified hubs for verification, weighing, and cryptographic security sealing.',
    placement: 'BELOW_SCHEDULE',
    priority: 75,
    startAt: '2025-01-01T00:00:00.000Z',
    endAt: '2028-12-31T23:59:59.000Z',
    status: 'ACTIVE',
    isDismissible: false,
    badgeAr: 'إشعار تشغيلي',
    badgeEn: 'Operational Notice',
    createdAt: '2026-01-20T09:00:00.000Z',
    updatedAt: '2026-01-20T09:00:00.000Z',
  },
  {
    id: 'ANN-004',
    titleAr: 'إطلاق مسار الرياض ⇄ القاهرة قريباً (مجدول)',
    titleEn: 'Upcoming Route: Riyadh ⇄ Cairo Launching Soon (Scheduled)',
    bodyAr: 'إعلان مستقبلي مجدول لا يظهر للعامة قبل تاريخ البدء.',
    bodyEn: 'Scheduled announcement not visible prior to startAt timestamp.',
    placement: 'HOME_FEATURED',
    priority: 50,
    startAt: '2028-06-01T00:00:00.000Z',
    endAt: '2029-12-31T23:59:59.000Z',
    status: 'SCHEDULED',
  ...
  {
    id: 'ANN-005',
    titleAr: 'عرض التوفير الموسمي المنتهي',
    titleEn: 'Expired Seasonal Offer',
    bodyAr: 'إعلان منتهي الصلاحية لا يظهر للعامة.',
    bodyEn: 'Expired announcement not visible to public.',
    placement: 'HOME_FEATURED',
    priority: 40,
  ...
  {
    id: 'ANN-006',
    titleAr: 'مسودة إعلان مسار جديد (مسودة)',
    titleEn: 'Draft Announcement for New Hub (Draft)',
    bodyAr: 'مسودة داخلية غير منشورة.',
    bodyEn: 'Internal draft not visible to public.',
    placement: 'TOP_BANNER',
    priority: 95,
    startAt: '2025-01-01T00:00:00.000Z',
    status: 'DRAFT',
  ...
  {
    id: 'ANN-007',
    titleAr: 'إعلان معطل إدارياً',
    titleEn: 'Administratively Disabled Announcement',
    bodyAr: 'معطل لا يظهر للعامة.',
    bodyEn: 'Disabled record not visible to public.',
    placement: 'HOME_FEATURED',
    priority: 60,
    startAt: '2025-01-01T00:00:00.000Z',
    status: 'DISABLED',
...
export const INITIAL_SHIPPING_RATES: ShippingRate[] = [
  // CUSTOMER_SHIPPING Rates (Strict separation: Rules 22, 23, 96)
  {
    id: 'rate-cust-jo-dz-v1',
  ...
  // TRAVELER_COMPENSATION Rates (Strict separation: Rules 22, 28, 97)
  {
    id: 'rate-trav-jo-dz-v1',
...
export const INITIAL_DAILY_EXCHANGE_RATES: DailyExchangeRate[] = [
  // JOD/DZD pair (SELL rate 195.00 DZD per JOD, BUY rate 190.00 DZD per JOD)
  {
    id: 'fx-jod-dzd-v1',
    baseCurrency: 'JOD',
    quoteCurrency: 'DZD',
